...
GCS_BUCKET = "retail-data-project"
...
BQ_PROJECT = "singular-node-473906-k7"
...
# MySQL Configuration
MYSQL_CONFIG = {
    "url": "jdbc:mysql://34.45.63.212:3306/retailerDB?useSSL=false&allowPublicKeyRetrieval=true",
...
def extract_and_save_to_landing(table, load_type, watermark_col):
    try:
        ...
        pandas_df['InvoiceDate'] = pd.to_datetime(pandas_df['InvoiceDate']).dt.strftime('%Y-%m-%d %H:%M:%S')
